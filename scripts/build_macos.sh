...
PROWRAP_EXECUTABLE_NAME="PROWRAP ISO 24817 Calculator v1.4"
PROWRAP_BUNDLE_NAME="$PROWRAP_EXECUTABLE_NAME.app"
PROWRAP_BUNDLE_IDENTIFIER="com.protapglobal.prowrap.iso24817calculator.v14"
PROWRAP_ARCHIVE_NAME="PROWRAP-Calculator-v1.4-macOS-arm64-M4-M5.zip"
